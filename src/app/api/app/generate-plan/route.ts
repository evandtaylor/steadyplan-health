...
function buildPlanPrompt(
  ...
  return [
    ...
    "Workout blocks may include a session title, duration, general structure, optional warm-up, main block, and optional cool-down.",
    ...
    "Respect instructions such as off-day workouts only, no workouts after shifts, short movement only after shifts, before shift only, keep first off day light, hard workouts only on off days, short sessions this week, or prioritize consistency over intensity.",
