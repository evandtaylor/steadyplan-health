...
function buildPlanPrompt(
  ...
  return [
    ...
    "If workout/training goals or saved workout preferences are provided, integrate them into the day-by-day timeline as general routine-planning workout blocks.",
    "Treat any Training profile details as defaults and any This week workout plan details as the current-week priority.",
    "Respect the requested workout detail level.",
    "If the user asks only to place workouts on the schedule, keep workout descriptions simple and focus on day/time placement.",
    "If the user asks for a simple session outline, include a session title, duration, and a short general structure.",
    "If the user asks for detailed checklist-style workouts, include warm-up, main block, optional finisher or cool-down, and matching checklist items.",
    "Workout blocks may include a session title, duration, general structure, optional warm-up, main block, optional finisher, and optional cool-down.",
    "Put workout action items in the Checklist section so the app can turn them into interactive checklist items.",
    "Keep workout placement realistic around submitted shifts, commute, appointments, errands, and responsibilities.",
    "Do not schedule hard workouts after long shifts unless the user specifically asks for that.",
    "Respect no-workout timing rules such as no workouts after shifts, no hard workouts before shifts, no workouts on first off day, off days only, weekends only, before work only, short movement only after shifts, keep first off day light, hard workouts only on off days, short sessions this week, or prioritize consistency over intensity.",
    "If the user asks to keep workdays light, use off days or short workday movement blocks.",
    "When the day is clear, put the workout in that day's timeline and include matching action items in that day's checklist.",
    "Do not provide medical, injury, rehab, treatment, fatigue treatment, or healthcare guidance.",
    "Do not prescribe intensity, progression, recovery, or weight-management advice as medical or treatment guidance.",
    "Use plain language and avoid medical or coaching jargon.",
    "Include a compact note near the end that workout blocks are general planning suggestions and should be adjusted for real life.",
    "",
    "Output rules:",
    "1. Create a realistic 7-day plan that feels like a helpful person wrote it.",
    "2. Start with exactly: Here's your week.",
    "3. Keep the whole plan short, skimmable, and app-ready.",
    ...
    "10. Make the day-by-day section a short daily timeline with only the blocks that matter.",
    ...
    "17. Do not use decorative markdown symbols, bold markers, horizontal rules, or nested bullets.",
    "18. Avoid repeating the same item in both the timeline and checklist unless it is truly useful as an action.",
    "",
    ...
    "Point to the first thing the user should do next in the plan.",
    "If today's date is unclear from the submitted week, use the first plan day or first workday as Next Up.",
    "",
    "Week rhythm rules:",
    "Use 3 bullets maximum.",
    "Summarize only the main shape of the week, such as work stretch, off days, meal prep, workouts, or errands.",
    "Do not write a strategy essay.",
    "",
    ...
    "Keep each time block to one short practical line when possible.",
    "When a workout fits that day, include a concise workout block with title, duration, and general structure.",
    ...
    "Group checklist items by day.",
    "Checklist items should be short actions only.",
    "Include workout checklist items when workout blocks are part of the plan, such as warm-up, main block, and cool-down.",
